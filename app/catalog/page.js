...
export const metadata = {
  title: 'Каталог VPS (ВПС): тарифы, цены и аренда серверов',
  description:
    'Аренда VPS (ВПС) и VDS: все тарифы виртуальных серверов одной таблицей с ценой и датой проверки. Фильтры по гео, памяти и ядрам, сортировка по цене за гигабайт памяти',
  ...
  return (
    <>
      ...
      <PageHead
        ...
        lead="Полная таблица тарифов виртуальных серверов (VPS, ВПС). Сравнивайте не по витринной цене, а по цене за гигабайт памяти: эта метрика показывает, где вы переплачиваете за бренд"
