...
export const metadata = {
  title: 'Каталог VPS: тарифы, цены и аренда серверов',
  description:
    'Аренда VPS: все тарифы виртуальных серверов одной таблицей с ценой и датой проверки. Фильтры по гео, памяти и ядрам, сортировка по цене за гигабайт памяти',
