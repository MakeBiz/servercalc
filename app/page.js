...
const FAQ = [
  ...
  },
  {
    ...
    a: 'У каждого тарифа есть дата проверки, она видна на витрине. Тариф, который не проверялся дольше семи дней, автоматически скрывается, а не показывается со старой ценой. Сейчас цены в базе демонстрационные, об этом написано отдельной плашкой',
  },
  {
        ...
        <div className="wrap">
          <div className="between mb">
            <div>
              ...
              <p className="lead">
                Отсортированы по минимальной цене в базе. {STATS.providers - STATS.partners} из{' '}
                {STATS.providers} включены без партнёрских отношений: каталог без них был бы неполным
              </p>
            </div>
