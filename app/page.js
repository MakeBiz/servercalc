...
export const metadata = {
  ...
  description:
    'Калькулятор подбора виртуального сервера: выберите задачу, ресурсы и географию — получите провайдеров и тарифы с проверенной ценой и датой сверки у каждой',
