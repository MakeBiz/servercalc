...
`.trim();
  ...
  return (
    <>
      ...
      <Script id="px-counter" src="https://makebiz-makebiz-platform-3628.twc1.net/px/t.js" strategy="afterInteractive" data-site="servercalc-ru" data-endpoint="https://makebiz-makebiz-platform-3628.twc1.net/px" />
