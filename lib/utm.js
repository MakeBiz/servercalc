 ...
 * Стандарт метки: utm_source=servercalc&utm_medium=<рынок>&utm_campaign=<место>&utm_content=<провайдер или тариф>
 * utm_medium несёт рынок (russia для этого сайта, задаётся в site.json утмMedium):
 * так в партнёрских кабинетах видно, из какой версии сайта пришёл переход.
 *
